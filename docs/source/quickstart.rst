...
understanding of `Sanic <https://sanicframework.org>`_, and that you have already
installed both Sanic and Sanic-RESTful-Api.  If not, then follow the steps in the
:ref:`installation` section.

A Minimal API
-------------

A minimal Sanic-RESTful-Api API looks like this: ::
...
Resourceful Routing
-------------------
The main building block provided by Sanic-RESTful-Api are resources.
...
Sanic-RESTful-Api understands multiple kinds of return values from view methods.
Similar to Sanic, you can return any iterable and it will be converted into a
response, including raw Sanic response objects. Sanic-RESTful-Api also support
...
While Sanic provides easy access to request data (i.e. querystring or POST
form encoded data), it's still a pain to validate form data. Sanic-RESTful
...
free. If an argument fails to pass validation, Sanic-RESTful will respond with
...
problem, Sanic-RESTful provides the :class:`fields` module and the
