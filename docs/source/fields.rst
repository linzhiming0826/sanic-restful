...
Sanic-RESTful-Api provides an easy way to control what data you actually render in
...
formatted as an RFC 822 date string (ISO 8601 is supported as well) ::
    ...
    from sanic_restful_api import Resource, fields, marshal_with
...
Sanic-RESTful-Api includes a special field, :class:`fields.Url`, that synthesizes a
