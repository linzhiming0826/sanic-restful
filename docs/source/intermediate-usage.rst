...
This page covers building a slightly more complex Sanic-RESTful-Api app that will
cover out some best practices when setting up a real-world Sanic-RESTful-Api-based
API. The :ref:`quickstart` section is great for getting started with your first
Sanic-RESTful-Api app, so if you're new to Sanic-RESTful-Api you'd be better off
...
There are many different ways to organize your Sanic-RESTful-Api app, but here
...
(:meth:`~sanic.Sanic.before_request`, :meth:`~sanic.Sanic.after_request`).
...
See :ref:`blueprints` in the Sanic documentation for what blueprints are and
why you should use them. Here's an example of how to link an :class:`Api`
up to a :class:`~sanic.Blueprint`. ::
